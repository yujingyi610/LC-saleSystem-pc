                    ...
                    <el-card class="box-card">
                        ...
                        <el-table :data="payTable" border style="width: 100%; margin-bottom: 20px">
                            ...
                            <el-table-column prop="delayStartDate" label="延期开始日期" width="160">
                                <template slot-scope="scope">
                                    {{scope.row.delayStartDate.split(' ')[0]}}
                                </template>
                            </el-table-column>
        ...
        methods: {
            ...
            handleSave() {// 保存
                ...
                data.payments.map((item, index)=>{
                    let date = item.delayStartDate.split(' ')[0]
                    item.delayStartDate = this.Time(date)
