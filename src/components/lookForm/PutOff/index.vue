    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-table :data="payTable" border style="width: 100%; margin-bottom: 20px">
                ...
                <el-table-column prop="beenDelayDays" label="已申请延期天数"></el-table-column>
                <el-table-column prop="delayFlag" label="是否申请延期"></el-table-column>
                <el-table-column prop="name" label="申请延期金额">
                    <template slot-scope="scope">
                        {{scope.row.receivableAmount - scope.row.receivedAmount}}
                    </template>
                </el-table-column>
                <el-table-column prop="delayStartDate" label="延期开始日期" width="160"></el-table-column>
                <el-table-column prop="delayEndDate" label="延期结束日期" width="160"></el-table-column>
                <el-table-column prop="delayDays" label="延期天数"></el-table-column>
                <el-table-column prop="totalDelayDays" label="累计申请延期天数"></el-table-column>
                <el-table-column prop="interestFlag" label="是否计息"></el-table-column>
                <el-table-column prop="interestRate" label="利率"></el-table-column>
                <el-table-column prop="interestAmount" label="到期应收利息" width="80"></el-table-column>
                <el-table-column prop="breakInterestRate" label="违约利率"></el-table-column>
            </el-table>
        </el-card>
        <!-- 其他信息 -->
        <el-card class="box-card">
