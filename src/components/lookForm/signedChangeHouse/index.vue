            ...
            <el-card class="box-card">
                ...
                <el-form :inline="true">
                    <el-form-item label="是否房票">
                        <el-switch v-model="switchFlag3" active-color="#13ce66" disabled></el-switch>
                    </el-form-item>
        ...
        <el-card class="box-card">
            ...
            <div v-show="!redactFlag">
                ...
                <el-card class="box-card">
                    ...
                    <el-table ref="multipleTable" :data="newDiscountInfo" style="width: 100%">
                        <el-table-column prop="discountName" label="折扣名称"></el-table-column>
                        <el-table-column prop="discountType" label="折扣类型"></el-table-column>
                        <el-table-column prop="discountMethod" label="优惠方式"></el-table-column>
                        <el-table-column prop="discountItem" label="折扣详情">
                    ...
                    <el-form :inline="true">
                        <el-form-item label="是否房票">
                            <el-switch v-model="newSwitchFlag3" active-color="#13ce66" disabled></el-switch>
                        </el-form-item>
                        <el-form-item label="房票金额" v-if="newSwitchFlag3">{{newTicketPrice}}</el-form-item>
                    </el-form>
                    <!-- <div style="overflow: hidden">
                        <span class="title_text">是否有特殊折扣:{{newSwitchFlag2?'是':'否'}}</span>
                    </div>
                    ...
                    <div style="overflow: hidden">
                        <div style="float: left">
                            <span>总价直减:</span>{{newBeautifyTotalPrice}}
                        </div>
                        <div style="float: right; line-height: 40px">
        ...
        methods: {
            show(dataAll, redactFlag) {
                ...
                if( dataAll ){
                    ...
                    this.newSwitchFlag2 = dataAll.NEW.ticketFlag;// 是否优惠券
                    ...
                    if( !redactFlag ){
                        ...
                        this.$refs.canChangeCellRef.show(dataAll.NEW)
                    }
