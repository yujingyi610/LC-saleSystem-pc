    ...
    >
      <div>
        <el-form :inline="true" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
          ...
          <el-form-item label="客户等级：" prop="customerLevel" :rules="rules.customerLevel" style="width: 275px;">
          ...
          <el-form-item label="跟进方式：" prop="followUpMethod" :rules="rules.followUpMethod" style="width: 275px;">
          ...
          <el-form-item label="关键行为：" prop="keyBehavior" :rules="rules.keyBehavior" style="width: 275px;">
          ...
          <el-form-item label="跟进内容：" :rules="rules.followUpContent" prop="followUpContent">
    ...
    data() {
      return {
        ...
        rules : {
          ...
          keyBehavior:[{ required: true, message: '请选择关键行为', trigger: 'change' }],
