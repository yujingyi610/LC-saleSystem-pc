<template>
    <div>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="createTime" label="制定时间"  ></el-table-column>
            ...
            <el-table-column label="操作"  >
                <template slot-scope="scope">
                    ...
                    <el-button type="text" @click="handleCommitPriceScheme(scope.row)">生效</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
...
import lookDialog from '../look'
    export default {
        ...
        methods: {
            ...
            handleCommitPriceScheme(row) {
                commitPriceScheme({id: row.id}).then(res=>{
                     ;
                    if( res.status === 200 ){
                        this.$message({
                            type: 'success',
