    ...
    <div id="newProject">
        ...
        <el-form :model="EssentialsMsg" class = "demo-ruleForm" label-width="100px" :rules="projectEssentialsRules" ref="Essentials" >
          ...
          <div class = "formLine">
            <el-form-item label="项目名称:" class = "essentialsItem line_height28"  label-width="90px"
                          prop="projectName">
              <el-input type="text" :maxlength=50 v-model="EssentialsMsg.projectName" auto-complete="off" size = "mini" class="EssentialsInputItem"></el-input>
            </el-form-item>

            <el-form-item label="归属公司:" class = "essentialsItem line_height28"
                          prop="projectCityId">
              <el-select v-model="EssentialsMsg.projectCityId" placeholder="请选择归属公司" @change="projectCityCompanyChange">
                <el-option
            ...
            <el-form-item label="管控方式:" prop="escrowType"   class = "essentialsItem line_height28"  >
          ...
          <!------------------第二行------------------------>
            ...
            <el-form-item label="项目负责人:" class = "essentialsItem line_height28" >
              <div @click.prevent="choiceProjectMgr">
                <v-input :maxlength=50 :val="EssentialsMsg.projectMgrName"  class="EssentialsInputItem"></v-input>
              </div>
            ...
            <el-form-item label="营销负责人:" class = "essentialsItem line_height28" >
              <div @click="choiceMarketMgr">
                <v-input :maxlength=50  :val="EssentialsMsg.marketMgrName"  class="EssentialsInputItem"></v-input>
              </div>
          ...
          <!------------------第三行------------------------>
            <div class = "formLine">
              <el-form-item label="项目地址:" class = "essentialsItem line_height28"
                ...
                <el-cascader expand-trigger="hover" clearable :options="EssentialsMsgProjectOption" v-model="EssentialsMsg.cityName" @active-item-change="handleCityChange" @change="celectCityChange" size = "mini"  class = "EssentialsInputItem" >
                </el-cascader>
              </el-form-item>

                <el-form-item label="启动会日期:" class = "essentialsItem line_height28" >
                  <el-date-picker v-model="EssentialsMsg.kickOffDate" type="date" placeholder="选择日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" size = "mini" class="EssentialsInputItem"></el-date-picker>
                </el-form-item>
      ...
      <div class = "messageBox">
        <div class="messageBoxHeader">
          ...
          <div class="headRight">
            <el-button  size = "mini"  type="primary" class = "saveBtn" @click="addPrjFormatList">新增业态</el-button>
          </div>
        </div>
        <div class = "boxBody">
          ...
          <el-table :data="prjFormatList" border tooltip-effect="dark"   >
            ...
            <el-table-column prop="coveredArea" label="建筑面积(m²)" align ="center">
              <template slot-scope="scope" >
                <el-input :maxlength=10 class="errorClass" size="mini" @change ="handleEditBuiltArea(scope.$index, scope.row)" v-model.number="scope.row.coveredArea" placeholder="只能输入数字"></el-input>
              </template>
            </el-table-column>
      ...
      <div class="messageBox">
        ...
        <div class = "boxBody carouselFigureBox">
          ...
          <div class= "carouselFigureItem">
            ...
            <div class="imageBox">
              <img v-show="surroundingEnvironmentPicture[0]" :src="surroundingEnvironmentPicture[0]"  @click="handleShowCarouselFigure(index = 0)">
            </div>
            <el-upload
              class="upload-demo"
          ...
          <div class= "carouselFigureItem">
            ...
            <div class="imageBox">
              <img v-show="trafficMap[0]" :src="trafficMap[0]"  @click="handleShowCarouselFigure(index = 2)">
            </div>
            <el-upload
              class="upload-demo"
              action="/zuul/api/storage/files/multipart/file"
          ...
          <div class= "carouselFigureItem">
            ...
            <div class="imageBox">
              <img v-show="effectPicture[0]" :src="effectPicture[0]"  @click="handleShowCarouselFigure(index = 1)" >
            </div>
            <el-upload
              class="upload-demo"
              action="/zuul/api/storage/files/multipart/file"
        ...
        <div class = "boxBody carouselFigureBox">
          <div class= "carouselFigureItem">
            ...
            <div class="imageBox">
              <img v-show="RealPicture[0]" :src="RealPicture[0]"  @click="handleShowCarouselFigure(index = 3)">
            </div>
            <el-upload
              class="upload-demo"
              action="/zuul/api/storage/files/multipart/file"
          ...
          <div class= "carouselFigureItem">
            ...
            <div class="imageBox">
              <img v-show="ModelPicture[0]" :src="ModelPicture[0]"  @click="handleShowCarouselFigure(index = 4)">
            </div>
            <el-upload
              class="upload-demo"
              action="/zuul/api/storage/files/multipart/file"
          ...
          <div class= "carouselFigureItem">
            ...
            <div class="imageBox">
              <img v-show="MatchingPicture[0]" :src="MatchingPicture[0]"  @click="handleShowCarouselFigure(index = 5)">
            </div>
            <el-upload
              class="upload-demo"
              action="/zuul/api/storage/files/multipart/file"
        ...
        <div class = "btnLine" style="padding:30px;border-top:solid thin rgb(220, 223, 230)">
          ...
          <el-button size = "mini"  type="primary" class = "mainBtn_ saveBtn_"  @click="saveEditor('Essentials')" v-has="'prj:project:edit'">保存</el-button>
        </div>
      </div>

      <!--  其他信息 -->
      <!--<div class="messageBox lastMseeageBox">
      ...
      <!--组织架构树对话框-->
      <el-dialog title="人员选择" :visible.sync="showOrgTree" v-if="showOrgTree" width="70%">
      ...
      <el-dialog
        title="提示"
        :visible.sync="cancelSave"
        width="30%"
        >
        <span>确定取消保存此项目吗？</span>
        <span slot="footer" class="dialog-footer">
          <el-button @click="cancelSave = false">取 消</el-button>
          <el-button type="primary" @click="cancelPrevPage">确 定</el-button>
        </span>
      </el-dialog>
    </div>
</template>
...
<script>
  ...
  import { projectInfoSave ,getCityCompanyList,getCityListForCascader, getLevel2} from "@/api/pages/mainPage/plan/projectInfo/index.js"
    ...
    export default {
      ...
      methods:{
        ...
        handleSelectionChange(list){
          ...
          console.log(this.scletedYeTypeList);
        ...
        saveEditor(Essentials){
          //console.log(this.$refs[Essentials]);
                    ...
                    　　  newArr.push(this.prjFormatList[i].formatName);
                          ...
                          if(i ==this.prjFormatList.length-1){
                               let prjResourceList = this.surroundingEnvironmentPictureMsg.concat(this.effectPictureMsg,this.trafficMapMsg,this.RealPictureMsg,this.ModelPictureMsg,this.MatchingPictureMsg);
                                let data_ = Object.assign({prjFormatList:this.prjFormatList},this.EssentialsMsg, this.projectInformationMsg, this.otherMsgList,this.projectCityCompanyMsg,{prjResourceList:prjResourceList});
                                ...
                                projectInfoSave(newData).then(res=>{
                                    if(res.status=="200"){
                                      this.$message({
                                        message: '此项目操作成功!',
                                        type: 'success',
                                      ...
                                      setTimeout(() => {
                                        //this.$router.go(-1);
                                        this.$router.push('/mainpage/plan/projectinfo');//返回项目信息页
                                      }, 1000);
                                    }else{
...
<style scoped>
  ...
  .imageBox{
    ...
    height: 140px;
    margin-bottom: 5px;
    background-image: url("/static/images/common/bg_project_new.png");
  }
