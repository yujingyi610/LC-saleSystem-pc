    ...
    <div class="importRoom">
        ...
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <span class="title">{{createHouseInfo.buildName}}房间<i class="el-icon-arrow-right"></i>导入房间</span>
        ...
        <view-room v-if="isShow" v-bind:createHouseInfo="createHouseInfo" v-on:goBack="handleGoBack"></view-room>
    </div>
</template>
...
import ViewRoom from './ViewRoom'
    export default {
        ...
        methods: {
            ...
            handleUpdate() {// 下载
                window.location.href = '/api/project/tpl/house_room_tpl.xls'
            },
