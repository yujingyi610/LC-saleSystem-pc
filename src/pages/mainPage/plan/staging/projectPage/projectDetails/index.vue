<template>
    <div id="bigPage" :style="IEVersion() == -1 ?'':IEVersion()=='edge'?'':'position:-ms-page'" class="bigPage">
        <div class="projectEssentials messageBox">
            <div class="messageBoxHeader">
                <h4 class="messageBoxTitle standardTitle">项目概要</h4>
                <div class="headRight">
                <span class ="editorBtn"  @click="close" >返回</span>
                </div>
            </div>
            <div class = "boxBody">
...
import { getProjectInfoById } from "@/api/pages/mainPage/plan/projectInfo/index.js"
    export default {
        ...
        created(){
            this.currentProjectId = this.ProgramObjective.id;
            let that = this;
