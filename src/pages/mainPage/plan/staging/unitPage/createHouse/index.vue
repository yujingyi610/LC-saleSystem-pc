    ...
    export default {
        ...
        methods: {
            ...
            handleFinish() {
                ...
                if( this.isSave ){
                    this.form.unitId = this.unitInfo.id;
                    this.form.paramMap = this.val;
                    ...
                    this.handleUpdateHouse(FormList);
                }
        ...
        created() {
            // if( this.chooseChild.num ){
            //     console.log(1111, this.chooseChild);
            //     this.form = this.chooseChild;
            // }
            if( this.chooseChild.id ){
                this.title = this.chooseChild.houseName;
                this.isSave = false;
                console.log(1111, this.chooseChild);
                let params2 = new URLSearchParams();
                params2.append( "id", this.chooseChild.itemRefId );
            ...
            this.form.unitName = this.unitInfo.unitName;
            let params = new URLSearchParams();
            params.append( "id", this.unitInfo.id );
