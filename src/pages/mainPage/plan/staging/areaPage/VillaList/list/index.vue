<template>
    <div>
        <el-card class="box-card space_bottom" v-show="!isShow">
            <div slot="header" class="clearfix">
                ...
                <div style="float: right">
                    ...
                    <el-button type="success" @click="FatherChange">楼栋视图</el-button>
                    <el-button type="success" @click="handleImportRoom" v-has="'prj:house:import'">导入房间</el-button>
                </div>
            </div>
            <el-table :data="buildingData" border style="text-align: center; font-size: 12px" @row-click="handleSeeMore" :row-class-name="tableRowClassName">
        ...
        <el-dialog :visible.sync="seeMore" class="width870">
            <span slot="title">
                ...
                <div style="float: right; margin-right: 50px">
                    <el-button type="text" @click.native.stop="redactFormItem2">编辑</el-button>
                </div>
            </span>
        ...
        <component :is="isShow" v-on:showClick="handleShow" :val="val"></component>                
    </div>
</template>

<script>
import importRoom from '../view/importRoom'
import {getAreaInfo, getBuildList, saveBuild, updateBuild, deleteBuild, upload, getSyncBuildList, addFromBuild} from "@/api/pages/mainPage/plan/house"
    export default {
        ...
        methods: {
            ...
            FatherChange() {// 切换视图
                this.$emit('changeChild','build-view')
            },
            submitForm(formName) {
            ...
            handleDel(index) {
                this.$confirm('此操作将不可逆, 是否继续?', '提示', {
                    ...
                    console.log(this.buildingData[index])
