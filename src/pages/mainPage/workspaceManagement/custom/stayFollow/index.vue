    ...
    <div class="envelope-box">
      ...
      <div class="envelope-title">
        <div class="mb-10 lh-28 of-hidden">
          <span class="color-title-green mr-20">待跟进</span>
          <!-- 排序 -->
            ...
            <el-table-column prop="roleName" label="操作" width="150px">
              <template slot-scope="scope">
                <div v-if="scope.row.propertyConsultName==='--'">
                  ...
                  <el-button v-has="'wb:fllow:view'" @click="handleCustomerSee(scope.row)" type="text">查看</el-button>                 
                </div>
                ...
                <div v-else-if="scope.row.hadFillType==='2'&&scope.row.propertyConsultName!='--'">
                  <el-button  v-has="'wb:fllow:add'" @click="handleFollowUpRecord(scope.row)" type="text">跟进</el-button>
                  <el-button v-has="'wb:fllow:view'" @click="handleCustomerSee(scope.row)" type="text">查看</el-button>
                </div>
