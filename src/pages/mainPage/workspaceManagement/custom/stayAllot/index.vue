    ...
    <div class="envelope-box">
      ...
      <div class="envelope-title">
        <div class="mb-10 lh-28 of-hidden">
          <span class="color-title-green mr-20">待分配</span>
          <!-- 排序 -->
            ...
            <el-table-column prop="roleName" label="操作" width="150px">
              <template slot-scope="scope">
                ...
                <div v-if="scope.row.propertyConsultName==='--'">
                  <el-button  v-has="'wb:assign:add'" @click="handleFollowUpFen(scope.row)" type="text">分配</el-button>
                  <el-button v-has="'wb:assign:view'" @click="handleCustomerSee(scope.row)" type="text">查看</el-button>                 
                </div>
          ...
          //获取项目id
           ...
           getCustomerPaging(data).then((res) => {
            ...
            this.total = res.data.total;   
              ...
              console.log('获取的客户列表',this.tableData)  
            }
          });
