    ...
    <div class="sign">
        <div class="searchForm">
            <el-form :inline="true" :model="formInline">
                ...
                <el-button type="success" @click="handleGetEvaluateVoList">查询</el-button>
        ...
        <el-card>
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="type" label="评价类别" show-overflow-tooltip></el-table-column>
                <el-table-column prop="commentName" label="评价人" show-overflow-tooltip></el-table-column>
                <el-table-column prop="agentName" label="经纪人" show-overflow-tooltip></el-table-column>
                <el-table-column prop="commentTime" label="评价时间" show-overflow-tooltip></el-table-column>
...
<script>
import {getEvaluateVoList, getAllProject} from '@/api/pages/mainPage/systemManagement/caseManagement/index.js'
    export default {
        data() {
            return{
        ...
        methods: {
            ...
            handleGetEvaluateVoList() {
                let params = new URLSearchParams();
                if( this.formInline.projectId ){
                    params.append('projectId', this.formInline.projectId)
                }
                ...
                getEvaluateVoList(params).then(res=>{
                     ;
                    if( res.status === 200 ){
                        if( res.data ){
