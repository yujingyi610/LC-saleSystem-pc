<template>
	<div>
		<!-- 撤诉弹框 -->
		<el-dialog title="撤诉" :visible.sync="Flag" width="900px" v-if="Flag">
            ...
            <el-card class="box-card">
				<div slot="header" class="clearfix">
					<span class="title">撤诉信息</span>
				</div>
				<el-form :model="indictForm">
                    <el-form-item label="撤诉日期:">
                        <el-date-picker v-model="indictForm.nolleDate" value-format="yyyy-MM-dd" type="date" placeholder="选择日期"></el-date-picker>
                    </el-form-item>
                    <el-form-item label="备注:">
                        <el-input type="textarea" v-model="indictForm.nolleRemark"></el-input>
                    </el-form-item>
                </el-form>
			</el-card>
            <el-card class="box-card"
  ...
  methods: {
    ...
    handleSave() {
      ...
      let data = {
          ...
          nolleRemark: this.indictForm.nolleRemark,
          nolleDate: this.indictForm.nolleDate,
