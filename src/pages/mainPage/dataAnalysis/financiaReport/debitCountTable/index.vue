<template>
  <div id="debitDetail">
    <header class="head-title">收款汇总表</header>
  ...
  export default {
    ...
    methods:{
      ...
      statistics(){
        ...
        this.tableSrc = CRM_GLOBAL.DATA_DEBIT_COUNT+"&city_id=" + city_id +"&project_id="+project_id+"&receive_start_date="+receive_start_date+"&receive_end_date="+receive_end_date+"&user_id="+user_id+"&check_status="+check_status+"&payment_item_name="+payment_item_name;
