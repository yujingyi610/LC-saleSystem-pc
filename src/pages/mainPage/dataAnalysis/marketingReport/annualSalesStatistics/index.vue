<template>
    ...
    <header class="head-title">历年销售情况统计表</header>
...
export default {
  ...
  methods: {
    ...
    statistics:function(){
      ...
      this.tableSrc = CRM_GLOBAL.DATA_YEARS_DETAILTABLE+"&CITY_ID="+CITY_ID+"" +
        "&PROJECT_ID="+PROJECT_ID+"&ESCROW_TYPE="+ESCROW_TYPE+"&IS_CHECKED="+IS_CHECKED+"&STATUS="+STATUS+"&DATE="+DATE+"&IS_MONEY="+IS_MONEY+'&REAL_NAME='+REAL_NAME+'&scroll=yes';
