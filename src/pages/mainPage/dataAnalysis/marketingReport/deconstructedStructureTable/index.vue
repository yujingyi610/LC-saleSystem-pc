<template>
  <div id="projectSalesDaily" class="projectDailySheet">
    <header class="head-title">去化结构表</header>
  ...
  export default {
    ...
    methods: {
      ...
      let CITY_ID = str;
        ...
        this.tableSrc = CRM_GLOBAL.DATA_STRUCK_TABLE+"&CITY_ID="+CITY_ID+"" +
          "&PROJECT_ID="+PROJECT_ID+"&ESCROW_TYPE="+ESCROW_TYPE+"&DATE="+DATE+'&REAL_NAME='+REAL_NAME+'&scroll=yes';
