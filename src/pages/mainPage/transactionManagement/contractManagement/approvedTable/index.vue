    ...
    <div>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column label="操作" width="150"  >
                <template slot-scope="scope">
                    <div v-if="scope.row.status === 'SUBMIT'">
...
<script>
import look from '../submittedTable/look'
...
import {getList, getInfo, deleteTrdSign, revokeTrdSign} from '@/api/pages/mainPage/transactionManagement/contractManagement'
    export default {
        watch: {
