<template>
    <div>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <template slot-scope="scope">
                <el-button @click.stop.prevent="handleRedact(scope.row)" type="text" v-has="'trd:rg:add'">编辑</el-button>
                <el-button @click.stop.prevent="handleDelect(scope.row)" type="text" v-has="'trd:rg:add'">删除</el-button>
            </template>
            </el-table-column>
        </el-table>
        <el-pagination
        ...
        <look-dialog ref="dialogRef" @upDate="handleGetList"></look-dialog>
...
import {listTrdSubscribeForm, getTrdSubscribeForm, deleteTrdSubscribeForm} from '@/api/pages/mainPage/transactionManagement/subscriptionManagement'
    export default {
        watch: {
