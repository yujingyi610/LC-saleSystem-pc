<template>
    <div>
        <el-dialog title="选择房间" :visible.sync="searchHouseFlag" width="1000px" v-if="searchHouseFlag">
            <!-- 头部搜索form -->
            ...
            <el-container v-if="buildInfo" class="main">
				<el-container class="main_con" style="width:70%;padding-bottom:50px;">
					<el-main class="main_con_main" style="overflow-y:scroll;height:100%;">
				...
				<el-aside width="33%">
					<el-card class="box-card" style="margin-bottom: 20px; min-height: 306px">
						...
						<div class="text item" v-if="houseInfo">
							...
							<!-- <div class="houseInfo_title">{{house.buildInfo.projectName}}<span>/</span>{{house.buildInfo.devstagesName}}<span>/</span>{{house.buildInfo.areaName}}<span>/</span>{{house.buildInfo.buildName}}<span>/</span>{{houseInfo.houseName}}</div> -->
